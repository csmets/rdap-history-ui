...
var _user$project$Model$History = F3(
	function (a, b, c) {
		return {objectClass: a, handle: b, versions: c};
	});
	...
	if (_p3.ctor === 'Just') {
		switch (_p3._0.ctor) {
			...
			case 'AutNum':
				return {
					ctor: '::',
					_0: _elm_lang$html$Html$text('ASN NYI'),
					_1: {ctor: '[]'}
				};
			case 'Entity':
				return {
			...
			default:
				return {
					ctor: '::',
					_0: _elm_lang$html$Html$text('Domain NYI'),
					_1: {ctor: '[]'}
				};
		}
	} else {
		return {
			ctor: '::',
			_0: _elm_lang$html$Html$text('Unrecognised object class'),
			_1: {ctor: '[]'}
		};
	}
};
...
var _user$project$Decode$toHistory = function (_p3) {
	var _p4 = _p3;
	return A3(_user$project$Model$History, _p4._0._0, _p4._0._1, _p4._1);
};
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(h.handle),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('WHOWAS (prototype)'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
...
var _user$project$Main$view_ = function (model) {
	var body = function () {
		...
		if (_p1.ctor === 'Left') {
			...
			return A2(_user$project$Render$viewAsList, _p1._0, model.selected);
		}
	}();
	return A2(
		_elm_lang$html$Html$div,
		...
		A2(
			_elm_lang$core$List$append,
			_user$project$Main$headerBar(model),
			body));
};
...
var _user$project$Main$errMsg = function (err) {
	...
	switch (_p2.ctor) {
		...
		case 'BadPayload':
			return A2(_elm_lang$core$Basics_ops['++'], 'bad response ', _p2._0);
		default:
			return 'invalid URL';
	}
};
var _user$project$Main$fromFetch = function (r) {
	var _p3 = r;
	if (_p3.ctor === 'Ok') {
		return _toastal$either$Either$Right(_p3._0);
	} else {
		return _toastal$either$Either$Left(
			_user$project$Main$errMsg(_p3._0));
	}
};
				...
				return {
					...
					_0: _user$project$Main$upd(
						_elm_lang$core$Native_Utils.update(
							model,
							{
								response: _user$project$Main$fromFetch(_p4._0),
								selected: 0
							})),
				...
				return {
					...
					_0: _user$project$Main$upd(
						_elm_lang$core$Native_Utils.update(
							model,
							{
								response: _toastal$either$Either$Left('Searching…'),
								resource: _p5
							})),
					_1: _user$project$Main$search(_p5)
				};
		}
	});
var _user$project$Main$init = function (resource) {
	return {
		ctor: '_Tuple2',
		_0: A4(
			_user$project$Model$Model,
			resource,
			_toastal$either$Either$Left('Loading…'),
			0,
			false),
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Main$init('203.133.248.0/24'),
